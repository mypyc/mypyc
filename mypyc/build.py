...
The main entrypoints are mypycify, which produces a list of extension
...
def mypycify(paths: List[str],
    ...
    Arguments:
      ...
      * mypy_options: Optionally, a list of command line flags to pass to mypy.
                      (This can also contain additional files, for compatability reasons.)
      * opt_level: The optimization level, as a string. Defaults to '' (meaning '-O').
    """
